...
submit.addEventListener("click", function() {
    ...
    var femaleAkanNames = ["Akosua", "Adowa", "Abenaa", "Akua", "Yaa", "Afua", "Ama"];
    ...
    if (dd < 1 || dd > 31){
     ...
     output.innerHTML = "hello! you were born on" + daysOfWeek[daysOfBirth] + ", and your Akan Name is " + femaleAkanNames[dayOfBirth];
 }
